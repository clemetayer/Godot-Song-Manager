...
func addSongToQueue(song : Song, transition : Transition) -> void:
...
func updateTrack(song : Song, track : String, transition : Transition, transition_bus_name : String):
	var tween : Tween
...
func removeSongs(transition : Transition) -> void:
...
func addSong(song : Song, transition : Transition) -> void:
	current_song = song
